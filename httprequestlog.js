...
`);
        ...
        */
        ...
        this.on("input",function(msg,nodeSend,nodeDone) {
            ...
            got(url,opts).then(res => {
				...
				RED.util.setMessageProperty(msg,"request",{url,opts});
				RED.util.setMessageProperty(msg,"response",res);
    ...
    RED.nodes.registerType("http req log",HTTPRequestLog,{
        credentials: {
            user: {type:"text"},
